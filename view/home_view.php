                            ...
                            <div class="col-md-12">
                                 <ul class="direction-aware row">
                                    <li class="col-md-4 portfolio-item da-item wow fadeInUp" data-mh="blog-posts">
                                        <a class="lb-link" href="satimg/img11.jpg" style="height:150px; width:150px;" title="Orange">
                                            <img src="satimg/img11.jpg"  style="height: 150px; width:150px;" class="img-responsive" alt="">
                                            <div>
                                        ...
                                        <div class="item-caption">
                                            ...
                                            <h4 class="pull-left">DELL Core i5</h4>
                                        </div>
                                    </li>
                                    <li class="col-md-4 portfolio-item da-item wow fadeInUp" data-mh="blog-posts">
                                        <a class="lb-link" href="satimg/img13.jpg" title="Choux">
                                            <img src="satimg/img13.jpg"  style="height:150px; width: 150px;" class="img-responsive" alt="">
                                            <div>
                                                <div class="portfolio-hover-content">
                                                    <i class="pe-7s-close fa-3x"></i>
                                                </div>
                                        ...
                                        <div class="item-caption">
                                            <h4 class="pull-left">Ordinateurs</h4> 
                                            <a class="pull-right btn btn-primary btn-outlined" href="index.php?action=produit2">Lire Plus</a> 
                                        </div>
                                    </li>
                                    <li class="col-md-4 portfolio-item da-item wow fadeInUp" data-mh="blog-posts">
                                        <a class="lb-link" href="satimg/s3.png" title="s3">
                                            <img src="satimg/s3.png"  style="height: 150px; width:150px;" class="img-responsive" alt="">
                                            <div>
                                                <div class="portfolio-hover-content">
                                                    <i class="pe-7s-close fa-3x"></i>
                                                </div>
                                        ...
                                        <div class="item-caption">
                                            <h4 class="pull-left">Electroniques</h4>
                                    ...
                                    <li class="col-md-4 portfolio-item da-item wow fadeInUp" data-mh="blog-posts">
                                            ...
                                            <img src="satimg/copy.jpg"  style="height: 150px; width: 150px;" class="img-responsive" alt="">
                                            <div>
                                                <div class="portfolio-hover-content">
                                                    <i class="pe-7s-close fa-3x"></i>
                                                </div>
                                        ...
                                        <div class="item-caption">
                                            <h4 class="pull-left">Copieur</h4>
                                            <a class="pull-right btn btn-primary btn-outlined" href="index.php?action=produit4">Lire Plus</a> 
                                        </div>
                                    </li>
                                    <li class="col-md-4 portfolio-item da-item wow fadeInUp" data-mh="blog-posts">
                                        <a class="lb-link" href="satimg/ordi.png" title="Orange">
                                            <img src="satimg/ordi.png" style="height: 150px; width: 150px;" class="img-responsive" alt="">
                                            <div>
                                                <div class="portfolio-hover-content">
                                                    <i class="pe-7s-close fa-3x"></i>
                                                </div>
                                        ...
                                        <div class="item-caption">
                                            <h4 class="pull-left">Desktop</h4>
                                            <a class="pull-right btn btn-primary btn-outlined" href="index.php?action=produit5">Lire Plus</a> 
                                        </div>
                                    </li>
                                    <li class="col-md-4 portfolio-item da-item wow fadeInUp" data-mh="blog-posts">
                                        <a class="lb-link" href="satimg/desktop.png" title="Oignon">
                                            <img src="satimg/desktop.png" style="height: 150px; width: 150px;" class="img-responsive" alt="">
                                            <div>
                                                <div class="portfolio-hover-content">
                                                    <i class="pe-7s-close fa-3x"></i>
                                                </div>
